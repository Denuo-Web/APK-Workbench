# Telemetry Agent Notes (apkw-telemetry)

## Role and scope
apkw-telemetry provides opt-in, local-first telemetry for usage events and crash reports.
...
## Crash reports
- Stored in `~/.local/share/apkw/telemetry/<app>/crashes/crash-<timestamp>-<pid>.json`.
...
## Environment / config
- APKW_TELEMETRY=1 enables usage events.
- APKW_TELEMETRY_CRASH=1 enables crash reports.
- APKW_TELEMETRY_INSTALL_ID overrides the install id.

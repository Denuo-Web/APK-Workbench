...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            job_addr: std::env::var("APKW_JOB_ADDR")
                .unwrap_or_else(|_| apkw_util::DEFAULT_JOB_ADDR.into()),
            toolchain_addr: std::env::var("APKW_TOOLCHAIN_ADDR")
                .unwrap_or_else(|_| apkw_util::DEFAULT_TOOLCHAIN_ADDR.into()),
            project_addr: std::env::var("APKW_PROJECT_ADDR")
                .unwrap_or_else(|_| apkw_util::DEFAULT_PROJECT_ADDR.into()),
            build_addr: std::env::var("APKW_BUILD_ADDR")
                .unwrap_or_else(|_| apkw_util::DEFAULT_BUILD_ADDR.into()),
            targets_addr: std::env::var("APKW_TARGETS_ADDR")
                .unwrap_or_else(|_| apkw_util::DEFAULT_TARGETS_ADDR.into()),
            observe_addr: std::env::var("APKW_OBSERVE_ADDR")
                .unwrap_or_else(|_| apkw_util::DEFAULT_OBSERVE_ADDR.into()),
            workflow_addr: std::env::var("APKW_WORKFLOW_ADDR")
                .unwrap_or_else(|_| apkw_util::DEFAULT_WORKFLOW_ADDR.into()),
...
pub(crate) fn write_json_atomic<T: Serialize>(path: &Path, value: &T) -> io::Result<()> {
    apkw_util::write_json_atomic(path, value)
}

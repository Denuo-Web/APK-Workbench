# WorkflowService Agent Notes (apkw-workflow)
...
## gRPC contract
- proto/apkw/v1/workflow.proto
- RPCs: RunPipeline, ReloadState

## Current implementation details
- Implementation lives in crates/apkw-workflow/src/main.rs with a tonic server; shared bootstrap,
  address defaults, and time helpers come from `apkw-util`.
...
## Environment / config
- APKW_WORKFLOW_ADDR sets the bind address (default 127.0.0.1:50057).
- APKW_JOB_ADDR, APKW_TOOLCHAIN_ADDR, APKW_PROJECT_ADDR, APKW_BUILD_ADDR,
  APKW_TARGETS_ADDR, APKW_OBSERVE_ADDR configure upstream services.

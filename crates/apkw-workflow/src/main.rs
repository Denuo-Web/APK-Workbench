...
async fn publish_log(
    ...
    publish_job_event(
        ...
        JobPayload::Log(JobLogAppended {
            chunk: Some(apkw_proto::apkw::v1::LogChunk {
                stream: "stdout".into(),
...
fn resolve_project_name(path: &str) -> String {
    Path::new(path)
        ...
        .unwrap_or_else(|| "apkw-project".to_string())
}
    ...
    if wants_verify {
        ...
        if toolchain_id.is_empty() {
            ...
            let resp = toolchain_client
                .verify_toolchain(apkw_proto::apkw::v1::VerifyToolchainRequest {
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    serve_grpc_with_telemetry(
        ...
        "workflow",
        "APKW_WORKFLOW_ADDR",
        apkw_util::DEFAULT_WORKFLOW_ADDR,
